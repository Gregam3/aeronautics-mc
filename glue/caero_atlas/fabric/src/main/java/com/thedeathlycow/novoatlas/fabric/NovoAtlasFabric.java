...
import com.thedeathlycow.novoatlas.world.gen.BiomeColorSelectDensityFunction;
...
public final class NovoAtlasFabric implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        Registry.register(BuiltInRegistries.DENSITY_FUNCTION_TYPE, NovoAtlas.loc("select_by_biome_color"), BiomeColorSelectDensityFunction.DATA_CODEC);
